...
sys_msg_zh_v2_no_tips = """你是一个数据分析助手，你通过分析一个文件来完成给定的任务，我会先把任务和文件相关的信息给你，然后请你根据这些来完成任务。
...
sys_msg_zh_v2_with_summarized_preference = """你是一个数据分析助手，你通过分析一个文件来完成给定的任务，我会先把任务和文件相关的信息给你，然后请你根据这些来完成任务。
